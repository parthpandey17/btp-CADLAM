...
import reachbytrain from "@/data/reachbytrain.json";
    ...
    <div>
      <div className=" space-y-4 ">
        ...
        <div className=" mb-4 p-3 lg:text-lg">
          ...
          and service provider. Additionally, travelers can opt for the airport shuttle service, which operates from the arrivals area. The shuttle fare is around 150 INR, and you can disembark near The LNM Institue Of Technology. Guests staying at nearby hotels can arrange pick-up services through their accommodations for added convenience.
      ...
      <div className=" space-y-4 ">
        ...
        <div className=" p-3 lg:text-lg ">
          <p>
            Peelamedu, the location of The LNM Institue Of Technology in Coimbatore,
            ...
            you can easily reach accommodations near The LNM Institue Of Technology
        ...
        <div className=" space-y-4 lg:text-lg">
          ...
          <p className=" p-2 ">
            ...
            Gandhipuram Bus Stand, navigating to The LNM Institue Of Technology is
